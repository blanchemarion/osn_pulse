...
def init_params():
    ...
    parser.add_argument(
        ...
        default="olfactory_calcium_unsupervised_config.yaml",
    )
...
def main(params, random_date):
    print("Train DUNL on neural data (independent kernels for each glomeruli).")
    ...
    if params["share_kernels_among_glomerulis"]:
        raise NotImplementedError(
            "This script is for independent kernels among glomeruli. Set share_kernels_among_glomerulis=False!"
        )

    glom_index = params["glom_index"]
    ...
    for data_path_cur in data_path_list:
        ...
        # go over the glomerulis sequentially -------------------------------------#
        # --------------------------------------------#
        # --------------------------------------------#
        # --------------------------------------------#
...
if __name__ == "__main__":
    ...
    for glom_index in glom_index_list:
        print("glom_index", glom_index)
        params["glom_index"] = glom_index
