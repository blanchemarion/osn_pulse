...
def init_params():
    ...
    parser.add_argument(
        ...
        help="data path",
        default= "",
            #[f"dopamine/Data/Expert_mice/general_format_processed_Day{i}_kernellength30_kernelnum1_trainready.pt" for i in range(1,4)], 
            # #[f"sparseness/Data/general_format_processed_roi{i}_HW1.npy" for i in range(12)],
    )
    parser.add_argument(
        "--data-folder",
        type=str,
        help="data folder",
        default = "dopamine/Data/Expert_mice" #"sparseness/Data"
    )
    parser.add_argument(
        "--kernel-length",
        type=int,
...
def main():
    ...
    if params["data_path"] == "":
        ...
        data_path_list = [
            ...
            if x.startswith("general_format_processed")
