...
def init_params():
    ...
    parser.add_argument(
        ...
        type=str,
        help="data path",
        default= ["sparseness\Data\general_format_processed_HW1.npy"]
                  #"sparseness\Data\general_format_processed_HW4.npy",
                  #"sparseness\Data\general_format_processed_Sphinx.npy"]
    )
    parser.add_argument(
        "--data-folder",
        type=str,
